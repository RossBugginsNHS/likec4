import { c as customInspectSymbol } from './core.C0Ye2OCr.mjs';
import { i as intersection, d as difference, u as union, a as stringHash, e as equals } from './core.CbsSAn1j.mjs';
...
import { m as hierarchyLevel, g as commonAncestor, n as nameFromFqn, d as isSameHierarchy } from './core.6VsRBhGY.mjs';
...
function t(...t){return t$3(n$1,t)}function n$1(e,t){if(e===t||Object.is(e,t))return  true;if(typeof e!=`object`||!e||typeof t!=`object`||!t)return  false;if(e instanceof Map&&t instanceof Map)return r$1(e,t);if(e instanceof Set&&t instanceof Set)return i(e,t);let n=Object.keys(e);if(n.length!==Object.keys(t).length)return  false;for(let r of n){if(!Object.hasOwn(t,r))return  false;let{[r]:n}=e,{[r]:i}=t;if(n!==i||!Object.is(n,i))return  false}return  true}function r$1(e,t){if(e.size!==t.size)return  false;for(let[n,r]of e){let e=t.get(n);if(r!==e||!Object.is(r,e))return  false}return  true}function i(e,t){if(e.size!==t.size)return  false;for(let n of e)if(!t.has(n))return  false;return  true}
