...
import { L as LikeC4Model } from '../shared/core.DjAM-S6a.mjs';
import { D as DeploymentFqn, F as Fqn } from '../shared/core.DX-WYEPA.mjs';
import { e as DeploymentElement, h as DeploymentRelationship, o as ParsedView, a0 as ParsedDeploymentView, P as ParsedLikeC4ModelData } from '../shared/core.CKNmSm2W.mjs';
import { f as Element, h as ModelRelation, r as AnyViewRuleStyle, v as AutoLayoutDirection, ag as ParsedElementView, i as ElementSpecification$1, k as RelationshipSpecification, T as TagSpecification, m as LikeC4ProjectStylesConfig } from '../shared/core.BMtVqKl7.mjs';
import { f as Participant, E as Expression, u as ElementShape, D as ThemeColor, s as BorderStyle, q as ShapeSize, r as SpacingSize, p as TextSize, y as RelationshipArrowType, v as RelationshipLineType } from '../shared/core.BnOetIAR.mjs';
...
import { Y as setProject, d as Aux, S as SpecAux, A as Any } from '../shared/core.CDOKQTW6.mjs';
import '../shared/core.8mmHFn9g.mjs';
 ...
 *  )
 */
declare function $style<B extends LikeC4ViewBuilder<AnyTypes, any, any>>(element: B['ElementExpr'] | B['TypedExpr'] | NonEmptyArray<B['ElementExpr']>, { notation, ...style }: AnyViewRuleStyle<any>['style'] & {
    notation?: string;
}): (b: B) => B;
