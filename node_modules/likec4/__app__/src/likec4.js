...
import "react-dom";
import { B as Background$1, a as BackgroundVariant, d as deepEqual, u as useFirstMountState, b as useCustomCompareEffect, s as shallowEqual, c as useStoreApi, e as useStore, f as useReactFlow, t, g as t$1, h as Bezier, i as getNodeDimensions, j as e, k as e$1, n, l as useMantineColorScheme, m as index, o as e$2, p as n$1, q as createSafeContext, r as atom, v as useIsomorphicLayoutEffect, w as useSyncedRef, x as t$2, y as e$3, z as t$3, M as MantineContext, A as MantineProvider, C as useMantineStyleNonce, L as LazyMotion, D as domMax, E as MotionConfig, F as e$4, G as t$4, H as t$5, I as t$6, J as t$7, K as useId$1, N as ErrorBoundary$1, T as ThemeIcon, O as Text, S as ScrollAreaAutosize, P as Button, Q as useSelector, R as setup, U as raise, V as emit, W as assertEvent, X as assign, Y as ActionIcon, Z as MotionButton, _ as MotionDiv, $ as Tooltip$6, a0 as Breadcrumbs, a1 as Menu, a2 as UnstyledButton, a3 as Badge, a4 as SegmentedControl, a5 as Divider$2, a6 as AnimatePresence, a7 as useHover, a8 as Popover, a9 as PopoverTarget, aa as PopoverDropdown, ab as Box$1, ac as FloatingIndicator, ad as Flex, ae as useDebouncedCallback, af as useUncontrolled, ag as clampUseMovePosition, ah as useMove, ai as useMergedRef, aj as TooltipGroup, ak as useDebouncedValue, al as e$5, am as EdgeLabelRenderer, an as useDebouncedState, ao as NodeToolbar, ap as Position, aq as Handle, ar as CopyButton, as as HoverCard, at as HoverCardTarget, au as HoverCardDropdown, av as Notification, aw as isMacOs, ax as Portal, ay as NavLink, az as ColorSwatch, aA as Space, aB as Stack, aC as CheckIcon, aD as rem, aE as useUpdateEffect$1, aF as Slider, aG as Paper, aH as Group, aI as MenuTarget, aJ as MenuDropdown, aK as MenuItem, aL as useFocusTrap, aM as useReducedMotionConfig, aN as useTimeoutEffect, aO as m, aP as ReactRemoveScroll, aQ as useThrottledCallback, aR as Input, aS as createScopedKeydownHandler, aT as t$8, aU as Highlight, aV as useMountEffect, aW as e$6, aX as useActorRef, aY as LayoutGroup, aZ as useTree, a_ as Alert, a$ as Tree, b0 as getBezierPath, b1 as t$9, b2 as t$a, b3 as e$7, b4 as t$b, b5 as t$c, b6 as n$2, b7 as r, b8 as t$d, b9 as n$3, ba as dagre, bb as t$e, bc as t$f, bd as t$g, be as ReactFlowProvider, bf as useStateHistory, bg as useRafEffect, bh as Panel, bi as Anchor, bj as Pill, bk as useViewportSize, bl as useSessionStorage, bm as t$h, bn as useDragControls, bo as useMotionValue, bp as CloseButton, bq as ActionIconGroup, br as Tabs, bs as TabsList, bt as TabsTab, bu as TabsPanel, bv as ScrollArea, bw as e$8, bx as useCallbackRef$1, by as animate, bz as e$9, bA as VisuallyHidden, bB as n$4, bC as useWindowEvent, bD as FocusTrap, bE as Title$1, bF as useFocusWithin, bG as useCombobox, bH as ComboboxOption, bI as Combobox, bJ as ComboboxTarget, bK as ComboboxDropdown, bL as ComboboxOptions, bM as ComboboxEmpty, bN as useHotkeys, bO as Grid, bP as GridCol, bQ as getNodesBounds, bR as getEdgePosition, bS as autoUpdate, bT as computePosition, bU as offset, bV as autoPlacement, bW as size, bX as hide, bY as useLocalStorage, bZ as Card, b_ as n$5, b$ as useRerender, c0 as t$i, c1 as d3line, c2 as curveCatmullRomOpen, c3 as getSmoothStepPath, c4 as t$j, c5 as produce, c6 as useTimeout, c7 as useDebouncedCallback$1, c8 as useCustomCompareMemo, c9 as t$k, ca as n$6, cb as t$l, cc as enqueueActions, cd as cancel, ce as fromPromise, cf as getViewportForBounds, cg as applyEdgeChanges, ch as applyNodeChanges, ci as sendTo, cj as stopChild, ck as spawnChild, cl as e$a, cm as fromCallback, cn as t$m, co as getHotkeyHandler, cp as nodeToRect, cq as and, cr as or, cs as t$n, ct as e$b, cu as toRgba, cv as t$o, cw as mix, cx as toHex, cy as scale, cz as e$c, cA as t$p } from "./vendors.js";
import { nonexhaustive, isTagColorSpecified, invariant as invariant$1, isStepEdgeId, extractStep, RichText as RichText$1, nonNullable, ancestorsFqn, nameFromFqn, isAncestor as isAncestor$1, DefaultMap as DefaultMap$1, Queue, whereOperatorAsPredicate, GroupElementKind, BBox as BBox$1, getParallelStepsPrefix } from "@likec4/core";
import { DefaultTagColors, LikeC4Styles as LikeC4Styles$1, ElementShapes } from "@likec4/core/styles";
import { invariant, toArray, ifirst, ifilter, compareNaturalHierarchically, nonexhaustive as nonexhaustive$1, ifind, nonNullable as nonNullable$1, DefaultMap, compareNatural, isAncestor, sortParentsFirst, nameFromFqn as nameFromFqn$1, isome, delay } from "@likec4/core/utils";
import { computeRelationshipsView, treeFromElements } from "@likec4/core/compute-view/relationships";
import { ensureSizes, BBox, RichText, exact } from "@likec4/core/types";
...
class Vector {
  ...
  static create(...args) {
    return args.length === 2 ? new Vector(args[0], args[1]) : new Vector(args[0].x, args[0].y);
  }
  /**
   * Adds two vectors.
...
function vector(...args) {
  return args.length === 1 && args[0] instanceof Vector ? args[0] : args.length === 2 ? new Vector(args[0], args[1]) : new Vector(args[0].x, args[0].y);
}
function extractMinimalInternalNode(nd) {
  ...
  return nd.measured && (minimal.measured = nd.measured), e$1(nd.width) && (minimal.width = nd.width), e$1(nd.height) && (minimal.height = nd.height), e$1(nd.initialWidth) && (minimal.initialWidth = nd.initialWidth), e$1(nd.initialHeight) && (minimal.initialHeight = nd.initialHeight), minimal;
}
function isEqualMinimalInternalNodes(a, b) {
  const posA = a.internals.positionAbsolute, posB = b.internals.positionAbsolute;
  if (posA.x !== posB.x || posA.y !== posB.y)
    return !1;
  const widthA = a.measured?.width ?? a.width ?? a.initialWidth ?? 0, widthB = b.measured?.width ?? b.width ?? b.initialWidth ?? 0;
  if (widthA !== widthB)
    return !1;
  const heightA = a.measured?.height ?? a.height ?? a.initialHeight ?? 0, heightB = b.measured?.height ?? b.height ?? b.initialHeight ?? 0;
...
function getNodeIntersectionFromCenterToPoint(intersectionNode, target, nodeMargin = 0) {
  const nodeCenter = getNodeCenter(intersectionNode), { width, height } = getNodeDimensions(intersectionNode), v = vector(target.x, target.y).subtract(nodeCenter), xScale = (nodeMargin + (width || 0) / 2) / v.x, yScale = (nodeMargin + (height || 0) / 2) / v.y, scale2 = Math.min(Math.abs(xScale), Math.abs(yScale));
...
function _update$1(current, update) {
  return update.map((next) => {
    ...
    if (existing && existing.type === next.type && existing.source === next.source && existing.target === next.target) {
      const isSameData = deepEqual(existing.data, next.data);
      return isSameData && deepEqual(existing.hidden ?? !1, next.hidden ?? !1) && deepEqual(existing.selected ?? !1, next.selected ?? !1) && deepEqual(existing.animated ?? !1, next.animated ?? !1) && deepEqual(existing.sourceHandle ?? null, next.sourceHandle ?? null) && deepEqual(existing.targetHandle ?? null, next.targetHandle ?? null) && deepEqual(existing.zIndex ?? 0, next.zIndex ?? 0) && deepEqual(existing.label ?? null, next.label ?? null) ? existing : {
        ...n$1(existing, ["hidden", "zIndex"]),
        ...next,
...
function updateEdges(current, update) {
  return e$2(update) ? _update$1(current, update) : (update = current, (current2) => _update$1(current2, update));
}
function _update(current, updated) {
  return updated.map((update) => {
    ...
    if (existing && deepEqual(existing.type, update.type)) {
      const isSameData = deepEqual(existing.data, update.data), { width: existingWidth, height: existingHeight } = getNodeDimensions(existing);
      return isSameData && deepEqual(existingWidth, update.initialWidth) && deepEqual(existingHeight, update.initialHeight) && deepEqual(existing.parentId ?? null, update.parentId ?? null) && deepEqual(existing.hidden ?? !1, update.hidden ?? !1) && deepEqual(existing.zIndex ?? 0, update.zIndex ?? 0) && deepEqual(existing.position, update.position) ? existing : {
        ...n$1(existing, ["measured", "parentId", "hidden", "zIndex"]),
        ...update,
...
function updateNodes(current, update) {
  return e$2(update) ? _update(current, update) : (update = current, (current2) => _update(current2, update));
}
...
}, HandlerNames = t$2(defaultHandlers), DiagramEventHandlersReactContext = createContext({
  ...t$3(HandlerNames, (name) => [name, null]),
  handlersRef: {
...
function DiagramEventHandlers({
  ...
  const handlersRef = useSyncedRef(
    handlers
  ), deps = HandlerNames.map((name) => e$3(handlers[name])), value = useMemo(() => ({
    ...t$3(HandlerNames, (name) => handlersRef.current[name] ? [name, (...args) => handlersRef.current[name]?.(...args)] : [name, null]),
    handlersRef
  }), [handlersRef, ...deps]);
...
function EnsureMantine({ children }) {
  ...
  }, []), mantineCtx ? /* @__PURE__ */ jsx(Fragment, { children }) : /* @__PURE__ */ jsx(MantineProvider, { defaultColorScheme: "auto", children });
}
...
const DiagramActorContextProvider = DiagramActorSafeContext.Provider;
...
function useDiagramContext(selector3, compare2 = shallowEqual, deps) {
  const actorRef = useDiagramActorRef(), select2 = useCallback((s) => selector3(s.context), deps ?? []);
  return useSelector(actorRef, select2, compare2);
}
function useOnDiagramEvent(event, callback) {
  const actorRef = useDiagramActorRef(), callbackRef = useRef(callback);
  callbackRef.current = callback, useEffect(() => {
...
}), navigationPanelActorLogic = _actorLogic$1, selectCompareLayoutState = ({ context: context2 }) => {
  const drifts = context2.view.drifts ?? null;
  return !context2.features.enableCompareWithLatest || !drifts ? {
    isEnabled: !1,
    isEditable: !1,
    isActive: !1,
    drifts: [],
    ...
    isEnabled: !0,
    isEditable: !context2.features.enableReadOnly,
    isActive: context2.toggledFeatures.enableCompareWithLatest === !0,
    drifts,
    layout: context2.view._layout ?? "auto"
  };
};
...
}), edgeLabelDefaultVariants = {
  pointerEvents: "all",
  isStepEdge: !1,
  cursor: "default"
}, edgeLabelCompoundVariants = [], edgeLabelSlotNames = [
  [
    "root",
...
], edgeLabelSlotFns = /* @__PURE__ */ edgeLabelSlotNames.map(([slotName, slotKey]) => [slotName, createRecipe(slotKey, edgeLabelDefaultVariants, getSlotCompoundVariant(edgeLabelCompoundVariants, slotName))]), edgeLabelFn = memo((props = {}) => Object.fromEntries(edgeLabelSlotFns.map(([slotName, slotFn]) => [slotName, slotFn.recipeFn(props)]))), edgeLabelVariantKeys = [
  "pointerEvents",
  "cursor",
  "isStepEdge"
], getVariantProps$1 = (variants) => ({ ...edgeLabelDefaultVariants, ...compact(variants) }), edgeLabel$1 = /* @__PURE__ */ Object.assign(edgeLabelFn, {
  __recipe__: !1,
  __name__: "edgeLabel",
  raw: (props) => props,
  classNameMap: {},
    ...
    Menu,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(Menu.Dropdown, { children: [
          /* @__PURE__ */ jsx(Menu.Item, { disabled: !0, rightSection: /* @__PURE__ */ jsx(Badge, { size: "xs", radius: "sm", children: "Soon" }), children: "Apply changes" }),
          /* @__PURE__ */ jsx(Menu.Item, { fz: "sm", onClick: onResetManualLayout, children: "Reset manual layout" })
        ] })
      ]
    }
  );
...
function ComparePanelControls() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    ctx.isEditable && /* @__PURE__ */ jsxs(HStack, { gap: "1", children: [
...
const isSelected = ".react-flow__edge.selected", edgeContainer = css({
  _reduceGraphics: {
    transition: "none"
  }
}), edgePathBg = css({
...
function EdgeContainer({
  ...
  return component === "svg" ? /* @__PURE__ */ jsx("svg", { style: style2, ...props, children }) : (invariant$1(component === "g", 'EdgeContainer: component must be "g" or "svg"'), /* @__PURE__ */ jsx("g", { style: style2, ...props, children }));
}
const EdgeLabel = forwardRef(({
  ...
  const stepNum = isStepEdgeId(id) ? extractStep(id) : null, classes2 = edgeLabel$1({
    pointerEvents,
    isStepEdge: stepNum !== null,
    cursor: selectable || stepNum !== null ? "pointer" : "default"
  }), hasLabel = e$5(label2) || e$5(technology);
  return /* @__PURE__ */ jsxs(
    MotionDiv,
    {
      ref,
      ...
      children: [
        ...
        hasLabel && /* @__PURE__ */ jsxs(Box, { className: classes2.labelContents, children: [
          e$5(label2) && /* @__PURE__ */ jsx(
            Box,
            {
              className: cx(
                classes2.labelText,
          ...
          e$5(technology) && /* @__PURE__ */ jsx(Box, { className: classes2.labelTechnology, children: "[ " + technology + " ]" }),
          children
        ] })
      ]
    }
...
const toCssVarValue = (value) => {
  if (value !== void 0)
    return e$1(value) ? `${Math.round(value)}px` : value;
};
...
const EdgePath = forwardRef(({
  ...
  let strokeDasharray;
  return isDotted ? strokeDasharray = "1,8" : isDashed && (strokeDasharray = "8,10"), /* @__PURE__ */ jsxs(Fragment, { children: [
    selectable && !isDragging && /* @__PURE__ */ jsx(
      "path",
      {
        className: cx(
...
const Root = forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  ...
  return /* @__PURE__ */ jsx(
    Markdown,
    {
      ...
      uselikec4palette: !0,
      hideIfEmpty: !0,
      maxHeight: description2.isMarkdown ? "8rem   " : void 0,
      lineClamp: isSm ? 3 : 5,
      ref
    }
  );
...
const style = {
  ...
  height: 5,
  transform: "translate(-50%, -50%)"
}, DefaultHandles = () => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx(Handle, { type: "target", position: Position.Top, style }),
  /* @__PURE__ */ jsx(Handle, { type: "target", position: Position.Left, style }),
  /* @__PURE__ */ jsx(Handle, { type: "source", position: Position.Right, style }),
  /* @__PURE__ */ jsx(Handle, { type: "source", position: Position.Bottom, style })
] }), GithubIcon = forwardRef((props, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    height: "24",
    width: "24",
...
const selector$4 = (ctx) => ({
  visible: ctx.features.enableReadOnly !== !0 && // Disable toggle in sequence mode
  ...
  const { visible, isReadOnly: isReadOnly2 } = useDiagramContext(selector$4), diagram = useDiagram();
  return /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", children: visible && /* @__PURE__ */ jsxs(
    UnstyledButton,
    {
      ...
      children: [
        isReadOnly2 ? /* @__PURE__ */ jsx(IconLock, { size: 14, stroke: 2 }) : /* @__PURE__ */ jsx(IconLockOpen2, { size: 14, stroke: 2 }),
        isReadOnly2 && /* @__PURE__ */ jsx(
          MotionDiv,
          {
            className: css({
              fontSize: "11px",
...
function ActiveWalkthroughControls() {
  const diagram = useDiagram(), {
    ...
    return {
      isParallel: e$5(s.activeWalkthrough?.parallelPrefix),
...
function ElementNodeDrifts({ data }) {
  ...
  return !drifts || drifts.length === 0 ? null : /* @__PURE__ */ jsx(
    Box,
    {
      ...
      children: /* @__PURE__ */ jsx(NodeToolbar, { isVisible: data.hovered === !0, align: "start", position: Position.Bottom, children: /* @__PURE__ */ jsx(
        Notification,
        {
          color: "orange",
          withBorder: !1,
...
function ColorSwatches({
  ...
  }, otherColors = t$2(theme.colors).filter((color) => !SemanticColors.includes(color));
...
function useHandlers(target, props) {
  const diagram = useDiagram(), [originalColor, setOriginalColor] = useState(null), onColorPreview = useCallbackRef((color) => {
    ...
    const { shape, color, ...style2 } = change;
...
function ElementNode$2(props) {
  ...
  return /* @__PURE__ */ jsxs(ElementNodeContainer, { nodeProps: props, children: [
    enableCompareWithLatest && /* @__PURE__ */ jsx(ElementNodeDrifts, { ...props }),
...
] }), hasModelFqn$1 = (data) => e$5(data.modelFqn);
function SequenceActorNode(props) {
  const { enableElementDetails } = useEnabledFeatures(), data = props.data, {
    id,
    positionAbsoluteY,
    data: {
      viewHeight,
  ...
  return useEffect(() => {
    setFound((current) => {
      const results = t$4(
        ...
        ifirst(20),
        toArray(),
        t$8((a, b) => compare(a.folder.path, b.folder.path))
      );
...
function selectWalkthroughNotes(s) {
  const isActive = e$6(s.activeWalkthrough), activeStepIndex = isActive ? s.xyedges.findIndex((e2) => e2.id === s.activeWalkthrough?.stepId) : -1;
  return {
    isActive,
    isParallel: isActive && e$5(s.activeWalkthrough?.parallelPrefix),
    hasNext: isActive && activeStepIndex < s.xyedges.length - 1,
    hasPrevious: isActive && activeStepIndex > 0,
    notes: isActive ? s.xyedges[activeStepIndex]?.data?.notes ?? RichText$1.EMPTY : null
  };
}
const WalkthroughPanel = memo$1(() => {
  const { isActive, notes } = useDiagramContext(selectWalkthroughNotes);
  return /* @__PURE__ */ jsx(AnimatePresence, { children: isActive && notes && !notes.isEmpty && /* @__PURE__ */ jsx(
    m.div,
    {
      layout: "position",
      className: css({
  ...
  const diagramActor = useDiagramActorRef(), view = useCurrentView(), viewModel = useOptionalCurrentViewModel(), actorRef = useActorRef(
  ...
  return useEffect(() => {
    const subscription = actorRef.on("navigateTo", (event) => {
      diagramActor.getSnapshot().context.view.id !== event.viewId && diagramActor.send({ type: "navigate.to", viewId: event.viewId });
    });
    return () => subscription.unsubscribe();
  }, [actorRef, diagramActor]), useUpdateEffect$1(() => {
...
const NavigationPanelImpl = ({ actor }) => {
  ...
  return /* @__PURE__ */ jsx(LayoutGroup, { children: /* @__PURE__ */ jsx(PopoverTarget, { children: /* @__PURE__ */ jsx(
    MotionDiv,
    {
      ...
      children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", children: isActiveWalkthrough ? /* @__PURE__ */ jsx(ActiveWalkthroughControls, {}) : /* @__PURE__ */ jsx(NavigationPanelControls, {}) })
    }
  ) }) });
...
function layoutRelationshipsView(data, scope) {
  ...
  t$4(
    ...
    t$9((grouped) => {
      ...
      g.node(source.id).outPorts.push(target.id), g.node(target.id).inPorts.push(source.id), g.setEdge(source.portId, target.portId, {
        ...
        relations: t$b(grouped, e$7("relation"))
      });
    })
  );
  ...
  const dagreBounds = applyDagreLayout$1(g), _calculatedNodeBounds = t$4(
    nodeIds,
    // Compound nodes have different portId
    n$2((n2) => n2.id === n2.portId),
    t$3((n2) => [n2.id, dagreBounds(n2.id)])
  );
  function nodeBounds(nodeId) {
    return _calculatedNodeBounds[nodeId] ??= t$4(
      g.children(nodeId) ?? [],
      n$2((id) => !id.endsWith(PortSuffix$1)),
      t$b((id) => nodeBounds(id)),
      t$f((bounds) => {
  ...
  const sortedPorts = (nodeId, type, ports) => t$4(
    ports,
    t$b((port, index2) => ({
  ...
  return {
    ...
    edges: g.edges().reduce((acc, e2) => {
      ...
      const {
        ...
        sourceHandle,
        targetHandle
      } = nonNullable$1(r(edges, (e22) => e22.name === ename)), onlyRelation = t$d(relations), label2 = onlyRelation?.title ?? "untitled", isMultiple = relations.length > 1, navigateTo = t$d(n$3(relations.flatMap((r2) => r2.navigateTo?.id ? r2.navigateTo.id : [])));
...
const sortByLabel = (a, b) => compareNatural(a.label, b.label);
...
function ElementDetailsCard({
  ...
  }), diagram = useDiagram(), viewModel = useCurrentViewModel(), nodeModel = fromNode ? viewModel.findNode(fromNode) : viewModel.findNodeWithElement(fqn2), elementModel = viewModel.$model.element(fqn2), [viewsOf, otherViews] = t$4(
    [...elementModel.views()],
    t$b((v) => v.$view),
    t$h((v) => v._type === "element" && v.viewOf === fqn2)
  );
  let defaultView = nodeModel?.navigateTo?.$view ?? elementModel.defaultView?.$view ?? null;
  defaultView?.id === viewId && (defaultView = null);
  const defaultLink = t$d(elementModel.links), controls = useDragControls(), isCompound = (nodeModel?.$node.children?.length ?? 0) > 0, _width = Math.min(700, windowWidth - MIN_PADDING * 2), _height = Math.min(650, windowHeight - MIN_PADDING * 2), fromPositon = rectFromNode ? {
...
function ElementMetata({
  ...
  const metadataEntries = t$7(metadata).sort(([a], [b]) => a.localeCompare(b));
...
function layoutRelationshipDetails(data, scope) {
  ...
  const dagreBounds = applyDagreLayout(g), _calculatedNodeBounds = t$4(
    nodeIds,
    // Compound nodes have different portId
    n$2((n2) => n2.id === n2.portId),
    t$3((n2) => [n2.id, dagreBounds(n2.id)])
  ...
  return {
    ...
    edges: g.edges().reduce((acc, e2) => {
      ...
      if (!ename)
        return acc;
      const { name, source, target, relationship, sourceHandle, targetHandle } = r(edges, (e22) => e22.name === ename), label2 = relationship.title ?? "untitled", navigateTo = relationship.navigateTo?.id ?? null, description2 = relationship.description ?? null, technology = relationship.technology ?? null;
      return acc.push({
        id: name,
        source,
        sourceHandle,
...
const selectSubject = (state) => ({
  ...
  const actor = useRelationshipDetailsActor(), subject = useSelector(actor, selectSubject, deepEqual), likec4model = useLikeC4Model(), view = likec4model.findView(subject.viewId) ?? null, data = useMemo(() => {
    let data2;
    if ("edgeId" in subject && e$5(subject.edgeId)) {
...
}).filter(e$9), compareSelectOverlays = (a, b) => a.length === b.length && a.every((overlay2, i) => overlay2.actorRef === b[i].actorRef);
function Overlays({ overlaysActorRef }) {
  const xyflowDomNode = useXYStore((s) => s.domNode), xyflowRendererDom = useMemo(() => xyflowDomNode?.querySelector(".react-flow__renderer") ?? null, [
    xyflowDomNode
  ]), overlays = useSelector(overlaysActorRef, selectOverlays, compareSelectOverlays), isMotionReduced = useReducedMotionConfig() ?? !1, isActiveOverlay = overlays.some((overlay2) => overlay2.type === "elementDetails");
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsx(DiagramFeatures.Overlays, { children: /* @__PURE__ */ jsx(ErrorBoundary$1, { FallbackComponent: ErrorFallback, onReset: () => overlaysActorRef.send({ type: "close.all" }), children: /* @__PURE__ */ jsx(LayoutGroup, { children: /* @__PURE__ */ jsx(AnimatePresence, { children: overlaysReact }) }) }) });
}
...
function queryAllFocusable(from, where, selector3 = `.${focusable}`) {
  ...
  const root = from.getRootNode();
  return e$3(root.querySelectorAll) ? [...root.querySelectorAll(`[data-likec4-search-${where}] ${selector3}`)] : (console.error("queryAllFocusable: root.querySelectorAll is not a function"), []);
}
...
function ViewButton({ className, view, loop = !1, search, ...props }) {
  const searchActorRef = useSearchActor(), diagram = useDiagram(), currentViewId = useCurrentViewId(), isCurrentView = view.id === currentViewId, navigate = () => {
...
const scrollArea = css({
  ...
  return useTimeoutEffect(() => {
    e$5(searchActorRef.getSnapshot().context.openedWithSearch) && focusToFirstFoundElement(ref.current);
...
function typedSystem(system) {
  return {
    get syncLayoutActorRef() {
      return system.get("syncLayout") ?? null;
    },
...
const RelationshipPopover = memo$1(() => {
  ...
  if (!diagramEdge || !sourceNode || !targetNode || e$4(diagramEdge.relations))
    return null;
  const [direct, nested] = t$4(
    ...
    n$2(e$5),
    t$h((r2) => r2.source.id === sourceNode.id && r2.target.id === targetNode.id)
  );
          ...
          size({
            ...
            apply({ availableHeight, availableWidth, elements }) {
              wasCanceled || Object.assign(elements.floating.style, {
                maxWidth: `${t(roundDpr(availableWidth), { min: 200, max: 400 })}px`,
                maxHeight: `${t(roundDpr(availableHeight), { min: 0, max: 500 })}px`
              });
            }
          }),
          hide({
  ...
  return /* @__PURE__ */ jsxs(
    VStack,
    {
      ...
      children: [
        ...
        r2.description.nonEmpty && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx(
            Box,
            {
              ...
              children: /* @__PURE__ */ jsx(Markdown, { value: r2.description, fontSize: "sm" })
            }
          )
        ] }),
            ...
            /* @__PURE__ */ jsxs(Stack, { gap: 4, flex: 1, children: [
              /* @__PURE__ */ jsx(Group, { gap: 4, flex: "0 0 auto", children: value.kinds.map((kind) => /* @__PURE__ */ jsx(
                Badge,
                {
                  ...
                  opacity: e$9(onlyKind) && onlyKind !== kind ? 0.25 : 1,
                  children: kind
                },
                kind
              )) }),
...
function useControlPoints({
  ...
  const insertControlPoint = useCallbackRef(({ x, y }) => {
    ...
    ], newPointV = vector(Math.round(x), Math.round(y));
...
const curve = d3line().curve(curveCatmullRomOpen.alpha(0.7)).x((d) => Math.round(d.x)).y((d) => Math.round(d.y)), isSameNodes = (a, b) => isEqualMinimalInternalNodes(a.sourceNode, b.sourceNode) && isEqualMinimalInternalNodes(a.targetNode, b.targetNode);
function useRelationshipEdgePath({
  ...
  const {
    ...
    useCallback(({ nodeLookup }) => {
      ...
      return {
        sourceNode: extractMinimalInternalNode(sourceNode2),
        targetNode: extractMinimalInternalNode(targetNode2)
      };
    }, [source, target]),
    isSameNodes
  );
  if (e$5(data.controlPoints) || isControlPointDragging) {
    const sourceCenterPos = { x: sourceX, y: sourceY }, targetCenterPos = { x: targetX, y: targetY }, nodeMargin = 6, points = data.dir === "back" ? [
      ...
      ...controlPoints,
      getNodeIntersectionFromCenterToPoint(sourceNode, t$i(controlPoints) ?? targetCenterPos, nodeMargin),
      sourceCenterPos
    ] : [
      sourceCenterPos,
      getNodeIntersectionFromCenterToPoint(sourceNode, n$4(controlPoints) ?? targetCenterPos, nodeMargin),
      ...controlPoints,
      getNodeIntersectionFromCenterToPoint(targetNode, t$i(controlPoints) ?? sourceCenterPos, nodeMargin),
      targetCenterPos
    ];
...
const getEdgeCenter = (path) => {
  ...
  const [isControlPointDragging, setIsControlPointDragging] = useState(!1), xyflow2 = useXYFlow(), diagram = useDiagram(), {
    enableNavigateTo,
    enableReadOnly
  ...
  } = props, navigateTo = enableNavigateTo ? data.navigateTo : void 0, {
    controlPoints,
    setControlPoints,
    insertControlPoint
  ...
  }, [edgePath, isControlPointDragging]), isControlPointDragging && (labelX = labelPos.x, labelY = labelPos.y);
  const updateEdgeData2 = useCallbackRef((controlPoints2) => {
    ...
    if (e2.pointerType !== "mouse" || e2.button !== 2)
      return;
  ...
  return isControlPointDragging && !props.data.hovered && (props = {
    ...
    /* @__PURE__ */ jsxs(EdgeContainer, { ...props, className: cx(isControlPointDragging && controlDragging), children: [
      /* @__PURE__ */ jsx(
        EdgePath,
        {
          edgeProps: props,
        ...
        EdgeLabelContainer,
        {
          ...
          children: /* @__PURE__ */ jsx(
            EdgeLabel,
            {
              ...
              edgeProps: props,
              children: !enabledEditing && navigateTo && /* @__PURE__ */ jsx(
                EdgeActionButton,
                {
                  onClick: (e2) => {
                    e2.stopPropagation(), diagram.navigateTo(navigateTo);
    ...
    enabledEditing && controlPoints.length > 0 && (selected || active || hovered || isControlPointDragging) && /* @__PURE__ */ jsx(
      ControlPoints,
      {
        edgeProps: props,
        controlPoints,
...
function ControlPoints({
  ...
  const xyflowStore = useXYStoreApi(), xyflow2 = useXYFlow(), edgeId = edgeProps.data.id, onLmbControlPointerDown = (index2, e2, domNode) => {
    ...
    switch (e2.button) {
      case 0: {
        e2.stopPropagation(), addSelectedEdges([edgeId]), onLmbControlPointerDown(index2, e2, domNode);
        break;
      }
      case 2:
        onRmbControlPointerDown(index2, e2);
...
function SequenceStepEdge(props) {
  const { enableNavigateTo } = useEnabledFeatures(), diagram = useDiagram(), { navigateTo } = props.data, isSelfLoop = props.source === props.target, isBack = props.sourceX > props.targetX, [path] = getSmoothStepPath({
...
function makeEdgeModifier(edge, anchor) {
  return (edgeLookup) => {
    const current = nonNullable(edgeLookup.get(edge.id), `Edge ${edge.id} not found`), { x: dx, y: dy } = anchor.diff;
    return dx === 0 && dy === 0 ? {
      id: edge.id,
      type: "replace",
      item: produce(current, (draft) => {
        draft.data.points = edge.data.points, draft.data.controlPoints = edge.data.controlPoints, draft.data.labelXY = edge.data.labelXY, draft.data.labelBBox = edge.data.labelBBox;
      })
    } : {
      id: edge.id,
      type: "replace",
      item: produce(current, (draft) => {
        draft.data.points = t$b(edge.data.points, (pt) => [pt[0] + dx, pt[1] + dy]), edge.data.controlPoints && (draft.data.controlPoints = (edge.data.controlPoints ?? []).map((pt) => ({
          x: pt.x + dx,
          y: pt.y + dy
        }))), edge.data.labelXY && (draft.data.labelXY = {
...
function createLayoutConstraints(xyflowApi, editingNodeIds) {
  const { parentLookup, nodeLookup, edges, edgeLookup } = xyflowApi.getState(), rects = /* @__PURE__ */ new Map(), ancestorsOf = new DefaultMap$1((nodeId) => {
  ...
  const rectsToUpdate = [...rects.values()], edgeModifiers = /* @__PURE__ */ new Map();
  for (const r2 of rectsToUpdate) {
    if (r2 instanceof CompoundRect)
      continue;
    const nested = nestedOf.get(r2.id);
    nested.size !== 0 && t$4(
      edges,
      n$2((e2) => !edgeModifiers.has(e2) && nested.has(e2.source) && nested.has(e2.target)),
      t$j((e2) => {
        edgeModifiers.set(e2, makeEdgeModifier(e2, r2));
      })
    );
  }
  const findMovingAncestor = (nodeId) => rects.get(nodeId) ?? ancestorsOf.get(nodeId).map((id) => rects.get(id)).find((s) => !!s) ?? null, movingNodes = new Set(editingNodeIds.flatMap((id) => [id, ...nestedOf.get(id)]));
  for (const edge of edges) {
    ...
    if (isSourceMoving && isTargetMoving) {
      let r2 = rects.get(edge.source) ?? rects.get(edge.target) ?? ancestorsOf.get(edge.source).map((id) => rects.get(id)).find((s) => !!s) ?? ancestorsOf.get(edge.target).map((id) => rects.get(id)).find((s) => !!s);
    ...
    if (isSourceMoving !== isTargetMoving) {
      ...
      if (!movingRect)
        continue;
      const controlPoints = edge.data.controlPoints ?? bezierControlPoints(edge.data.points), sourceNode = nonNullable(nodeLookup.get(edge.source), `Source node ${edge.source} not found`), targetNode = nonNullable(nodeLookup.get(edge.target), `Target node ${edge.target} not found`), sourceIntersectionPoint = vector(getNodeIntersection(sourceNode, targetNode)), targetIntersectionPoint = vector(getNodeIntersection(targetNode, sourceNode)), [anchorV, staticV] = isSourceMoving ? [sourceIntersectionPoint, targetIntersectionPoint] : [targetIntersectionPoint, sourceIntersectionPoint], staticToAnchor = anchorV.subtract(staticV), staticToAnchorLength = staticToAnchor.length();
      edgeModifiers.set(edge, (edgeLookup2) => {
        const current = nonNullable(edgeLookup2.get(edge.id), `Edge ${edge.id} not found`), { x: dx, y: dy } = movingRect.diff;
        if (dx === 0 && dy === 0)
          return {
            id: edge.id,
            type: "replace",
        ...
        const d = vector(dx, dy), relativePoint = (pt) => {
          const p = vector(pt), projLength = p.subtract(staticV).dot(staticToAnchor), coeff = Math.min(projLength / staticToAnchorLength ** 2, 1), newP = p.add(d.multiply(coeff));
          return {
            x: Math.round(newP.x),
            y: Math.round(newP.y)
          };
        ...
        return {
          ...
          item: produce(current, (draft) => {
            ...
            edge.data.labelXY && (draft.data.labelXY = relativePoint(edge.data.labelXY));
          })
        };
      });
      continue;
  ...
  function updateXYFlow() {
    ...
    changes.length > 0 && xyflowApi.getState().triggerEdgeChanges(changes);
  }
  ...
  function onMove() {
    rectsToUpdate.length !== 0 && (animationFrameId ??= requestAnimationFrame(() => {
      ...
      for (const id of editingNodeIds) {
        const rect = nonNullable(rects.get(id)), node2 = nonNullable(nodeLookup.get(id));
...
function useLayoutConstraints() {
  ...
  return useMemo(() => ({
    onNodeDragStart: (_event, xynode) => {
      ...
      const { nodeLookup } = xystore.getState(), draggingNodes = t$4(
        Array.from(nodeLookup.values()),
        n$2((n2) => n2.draggable !== !1 && (n2.dragging === !0 || n2.id === xynode.id || n2.selected === !0))
      );
      t$1(draggingNodes, 1) && (solverRef.current = createLayoutConstraints(xystore, t$b(draggingNodes, (x) => x.id)));
    },
    onNodeDrag: (_event) => {
...
function prepareNodeTypes(nodeTypes2) {
  return !nodeTypes2 || e$4(nodeTypes2) ? builtinNodes : {
...
const selectXYProps = ({ context: ctx, children }) => {
  const toggledFeatures = ctx.toggledFeatures, enableReadOnly = ctx.features.enableReadOnly || toggledFeatures.enableReadOnly === !0, isNotEditingEdge = enableReadOnly || children.syncLayout?.getSnapshot().context.editing !== "edge";
  return {
    enableReadOnly,
...
function diagramToXY(opts) {
  ...
  for (; next = queue.dequeue(); ) {
    ...
    const id = ns + node2.id, drifts = node2.drifts ?? null, base = {
      id,
      deletable: !1,
      position,
      ...
      description: RichText$1.from(node2.description),
      height: node2.height,
      width: node2.width,
      level: node2.level,
      color: node2.color,
  ...
  for (const edge of view.edges) {
    ...
    xyedges.push({
      ...
      data: {
        ...
        notes: RichText$1.from(edge.notes),
...
function sequenceLayoutToXY(view) {
  const { actors, steps, compounds, parallelAreas, bounds } = view.sequenceLayout, xynodes = [], xyedges = [], getNode = (id) => nonNullable(view.nodes.find((n2) => n2.id === id));
...
function makeDiagramApi(actor) {
  return {
    ...
    startEditing: (subject) => {
      ...
      invariant(syncActor, "No sync layout actor found in diagram actor system"), syncActor.send({ type: "editing.start", subject });
    },
    stopEditing: (wasChanged = !1) => {
      const syncActor = typedSystem(actor.system).syncLayoutActorRef;
      invariant(syncActor, "No sync layout actor found in diagram actor system"), syncActor.send({ type: "editing.stop", wasChanged });
    },
    undoEditing: () => {
      const syncActor = typedSystem(actor.system).syncLayoutActorRef;
      ...
      return hasUndo && syncActor.send({ type: "undo" }), hasUndo;
    },
    align: (mode) => {
    ...
    findEdge: (xyedgeId) => actor.getSnapshot().context.xyedges.find((e2) => e2.data.id === xyedgeId) ?? null,
    /**
     * @warning Do not use in render phase
     */
...
function mergeXYNodesEdges({ context: context2, event }) {
  ...
  const nextView = event.view, isSameView = context2.view.id === nextView.id, currentNodes = context2.xynodes, xynodes = event.xynodes.map((update) => {
    ...
    if (existing) {
      ...
      return deepEqual(existing.type, update.type) && deepEqual(existingWidth, update.initialWidth) && deepEqual(existingHeight, update.initialHeight) && deepEqual(existing.hidden ?? !1, update.hidden ?? !1) && deepEqual(existing.position, update.position) && deepEqual(existing.data, update.data) && deepEqual(existing.parentId ?? null, update.parentId ?? null) ? existing : {
        ...n$1(existing, ["measured", "parentId", "hidden"]),
        ...update,
        // Force dimensions from update
        width: update.initialWidth,
        height: update.initialHeight
  ...
  if (isSameView && (!nextView.drifts || nextView.drifts.length === 0)) {
    ...
    xyedges = event.xyedges.map((update) => {
      ...
      return existing === update ? existing : existing && existing.type === update.type ? deepEqual(existing.hidden ?? !1, update.hidden ?? !1) && deepEqual(existing.data, update.data) && deepEqual(existing.source, update.source) && deepEqual(existing.target, update.target) && deepEqual(existing.sourceHandle, update.sourceHandle) && deepEqual(existing.targetHandle, update.targetHandle) ? existing : {
        ...n$1(existing, ["hidden", "sourceHandle", "targetHandle"]),
        ...update,
        data: {
          ...existing.data,
          ...update.data
...
function updateNodeData({ context: context2, event }) {
  return console.log("updateNodeData called", event), assertEvent(event, "update.nodeData"), { xynodes: context2.xynodes.map((node2) => {
...
function resetEdgeControlPoints(nodeLookup, edge) {
  ...
  if (source === target) {
    ...
    return [
      centerOfTopBoundary.add(vector(-80 / 2.5, -80)),
      centerOfTopBoundary.add(vector(80 / 2.5, -80))
    ];
  }
  const sourceToTargetVector = targetCenter.subtract(sourceCenter), sourceBorderPoint = getBorderPointOnVector(source, sourceCenter, sourceToTargetVector), targetBorderPoint = getBorderPointOnVector(target, targetCenter, sourceToTargetVector.multiply(-1));
...
function updateActiveWalkthrough({ context: context2 }) {
  const { stepId, parallelPrefix } = nonNullable(context2.activeWalkthrough, "activeWalkthrough is null"), step = nonNullable(context2.xyedges.find((x) => x.id === stepId));
  return {
...
class GridAligner extends Aligner {
  ...
  computeLayout(nodes) {
    const sortedNodeRects = t$4(
      nodes,
      t$g((r2) => r2[this.primaryAxisCoord])
  ...
  spaceAround(layer, layoutRect, placeNextLayerAt) {
    ...
    const result = /* @__PURE__ */ new Map();
    for (let node2 of t$g(layer.nodes, (n2) => n2[this.secondaryAxisCoord]))
      result.set(node2.id, {
        [this.secondaryAxisCoord]: placeNextNodeAt,
        [this.primaryAxisCoord]: placeNextLayerAt
      }), placeNextNodeAt += node2[this.secondaryAxisDimension] + margin;
...
function createViewChange(parentContext) {
  const {
    ...
    xyedges,
    xystore
  } = parentContext, { nodeLookup } = xystore.getState(), movedNodes = /* @__PURE__ */ new Set(), xynodesLookup = t$l(xynodes, (n2) => n2.data.id), xyedgesLookup = t$l(xyedges, (e2) => e2.data.id), nodes = t$b(view.nodes, (node2) => {
    const xynode = xynodesLookup[node2.id];
    if (!xynode)
      return node2;
    const internal = nodeLookup.get(xynode.id), dimensions = getNodeDimensions(internal);
    return !isSamePoint(internal.internals.positionAbsolute, node2) || node2.width !== dimensions.width || node2.height !== dimensions.height || node2.shape !== xynode.data.shape || node2.color !== xynode.data.color || node2.style.border !== xynode.data.style.border || node2.style.opacity !== xynode.data.style.opacity ? (movedNodes.add(xynode.id), {
      ...node2,
    ...
    const _updated = {
      ...n$1(edge, ["controlPoints"]),
      points: data.points
    };
    return data.labelXY && data.labelBBox && (_updated.labelBBox = {
      ...data.labelBBox,
      ...data.labelXY
    }), data.labelBBox && (_updated.labelBBox ??= data.labelBBox), t$1(controlPoints, 1) && (_updated.controlPoints = controlPoints), _updated;
  });
  return {
...
function viewToNodesEdge(view) {
  const xynodes = [], xyedges = [], nodeLookup = /* @__PURE__ */ new Map(), queue = Queue.from(view.nodes.reduce(
    (acc, node2) => (nodeLookup.set(node2.id, node2), node2.parent || acc.push({ node: node2, parent: null }), acc),
    []
  )), nodeById = (id) => nonNullable(nodeLookup.get(id), `Node not found: ${id}`);
  let next;
  for (; next = queue.dequeue(); ) {
    const { node: node2, parent } = next, isCompound = t$1(node2.children, 1) || node2.kind == GroupElementKind;
    if (isCompound)
...
const findRootSubject = (nodes) => nodes.find(
  (n2) => n2.data.column === "subjects" && e$8(n2.parentId)
  ...
  }, parent = nonNullable$1(self._parent);
  ...
  for (const {
    ...
    xyedges.push({
      ...
      data: {
        ...
        navigateTo,
        line,
        description: RichText$1.from(description2),
        ...technology && { technology }
      }
    });
  }
...
const ViewPadding = {
  ...
  guards: {
    ...
    "close specific overlay?": ({ context: context2, event }) => (assertEvent(event, "close"), e$a(event.actorId) && context2.overlays.some((o) => o.id === event.actorId)),
    "last: is relationshipDetails?": ({ context: context2 }) => t$i(context2.overlays)?.type === "relationshipDetails",
    "last: is relationshipsBrowser?": ({ context: context2 }) => t$i(context2.overlays)?.type === "relationshipsBrowser"
  }
}), closeLastOverlay = () => machine$1.enqueueActions(({ context: context2, enqueue }) => {
  if (context2.overlays.length === 0)
    return;
  const lastOverlay = t$i(context2.overlays)?.id;
  ...
  for (const { id } of t$m(context2.overlays))
  ...
  const currentOverlay = t$i(context2.overlays);
  ...
  id: "hotkey"
}), stopListeningToEsc = () => machine$1.stopChild("hotkey"), _overlaysActorLogic = machine$1.createMachine({
  id: "overlays",
  context: () => ({
    seq: 1,
    overlays: []
  ...
  const escHandler = getHotkeyHandler([
    ["Escape", (event) => {
      event.stopPropagation(), console.log("Escape karsarsey pressed"), sendBack({ type: "key.esc" });
    }, {
      preventDefault: !0
    }]
...
}), undoHotKeyActorLogic = fromCallback(({ sendBack }) => {
  const ctrlZHandler = getHotkeyHandler([
    ["mod + z", (event) => {
      console.log("Undo hotkey pressed"), event.stopPropagation(), sendBack({ type: "undo" });
    }, {
      preventDefault: !0
    }]
  ]);
...
}), diagramActorRef = function(system) {
  return system.get("diagram");
}, syncManualLayout = setup({
  delays: {
    timeout: 2e3
  },
  guards: {
...
}), pushHistory = syncManualLayout.assign(({ context: context2 }) => {
  const snapshot = context2.beforeEditing;
  if (!snapshot)
    return {};
  const prevHistoryItem = t$i(context2.history);
  return deepEqual(prevHistoryItem?.xyedges, snapshot.xyedges) && deepEqual(prevHistoryItem?.xynodes, snapshot.xynodes) ? {
    beforeEditing: null
  } : {
    beforeEditing: null,
    history: [
...
}), popHistory = syncManualLayout.assign(({ context: context2 }) => context2.history.length === 0 ? {} : {
  history: context2.history.slice(0, -1)
}), startEditing$1 = syncManualLayout.assign(({ system, event }) => {
  assertEvent(event, "editing.start");
  const parentContext = diagramActorRef(system).getSnapshot().context;
  return {
    editing: event.subject,
    beforeEditing: {
      xynodes: t$b(parentContext.xynodes, (n2) => ({ ...n2 })),
      xyedges: t$b(parentContext.xyedges, (e2) => ({ ...e2 })),
      change: createViewChange(parentContext),
      view: parentContext.view,
      synched: !1
    }
  };
}), ensureHotKey = syncManualLayout.enqueueActions(({ check, enqueue, self }) => {
  const hasUndo = check("can undo"), undoHotKey = self.getSnapshot().children.undoHotKey;
  if (undoHotKey && !hasUndo) {
    enqueue.stopChild(undoHotKey);
    return;
  }
  !undoHotKey && hasUndo && enqueue.spawnChild("undoHotKeyActorLogic", {
    id: "undoHotKey"
  });
}), stopEditing$1 = syncManualLayout.enqueueActions(({ event, enqueue }) => {
  assertEvent(event, "editing.stop"), event.wasChanged && (enqueue.cancel("sync"), enqueue(pushHistory), enqueue.raise({ type: "sync" }, { id: "sync", delay: 50 })), enqueue.assign({
    beforeEditing: null,
    editing: null
  });
}), emitOnChange$1 = syncManualLayout.sendTo(
...
), markHistoryAsSynched = syncManualLayout.assign(({ context: context2, event }) => (assertEvent(event, "synced"), {
  history: context2.history.map((i) => ({
    ...i,
    synched: !0
  })),
  beforeEditing: context2.beforeEditing ? {
    ...context2.beforeEditing,
    synched: !0
  } : null
})), undo = syncManualLayout.enqueueActions(({ context: context2, enqueue, system }) => {
  const lastHistoryItem = t$i(context2.history);
  if (!lastHistoryItem)
    return;
  enqueue(popHistory), enqueue(ensureHotKey);
  ...
  }), lastHistoryItem.synched && enqueue.sendTo(diagramActor, {
    type: "emit.onChange",
    change: lastHistoryItem.change
  });
}), idle$1 = syncManualLayout.createStateConfig({
  tags: "ready",
  entry: [
    assign({
      beforeEditing: null,
...
}), editing = syncManualLayout.createStateConfig({
  on: {
    "editing.stop": {
      actions: [
        stopEditing$1,
...
}), pending = syncManualLayout.createStateConfig({
  tags: "pending",
  on: {
    sync: {
      target: "pending",
  ...
  after: {
    timeout: {
      target: "idle",
      actions: emitOnChange$1
    }
  }
}), paused = syncManualLayout.createStateConfig({
  tags: "pending",
  on: {
    "editing.stop": {
      actions: [
...
}), _syncManualLayoutActorLogic = syncManualLayout.createMachine({
  initial: "idle",
  context: ({ input: input2 }) => ({
    ...input2,
    history: [],
...
}), syncManualLayoutActorLogic = _syncManualLayoutActorLogic, isReadOnly$1 = (context2) => (context2.features.enableReadOnly || context2.toggledFeatures.enableReadOnly === !0) && (context2.view._type !== "dynamic" || context2.dynamicViewVariant !== "sequence"), machine = setup({
  actors: {
  ...
  guards: {
    ...
    "enabled: FocusMode": ({ context: context2 }) => (context2.toggledFeatures.enableFocusMode ?? context2.features.enableFocusMode) === !0 && isReadOnly$1(context2),
    "enabled: Readonly": ({ context: context2 }) => isReadOnly$1(context2),
    ...
    "enabled: DynamicViewWalkthrough": ({ context: context2 }) => isReadOnly$1(context2) && context2.features.enableDynamicViewWalkthrough,
    "not readonly": ({ context: context2 }) => !isReadOnly$1(context2),
...
const trigger = {
  navigateTo: () => machine.emit(({ context: context2 }) => ({
    type: "navigateTo",
    viewId: nonNullable(context2.lastOnNavigate, "Invalid state, lastOnNavigate is null").toView
  }))
}, xyflow = {
  fitDiagram: (params) => machine.createAction(({ context: context2, event }) => {
    params ??= event.type === "fitDiagram" ? event : {};
    const {
      bounds = context2.view.bounds,
      duration = 450
    } = params, { width, height, panZoom, transform } = nonNullable(context2.xystore).getState(), maxZoom = Math.max(1, transform[2]), viewport = getViewportForBounds(
      bounds,
      width,
      height,
      MinZoom,
    ...
    viewport.x = Math.round(viewport.x), viewport.y = Math.round(viewport.y), panZoom?.setViewport(viewport, duration > 0 ? { duration, interpolate: "smooth" } : void 0).catch(
      console.error
    );
  }),
  fitFocusedBounds: () => machine.createAction(({ context: context2 }) => {
    const isActiveSequenceWalkthrough = !!context2.activeWalkthrough && context2.dynamicViewVariant === "sequence", { bounds, duration = 450 } = isActiveSequenceWalkthrough ? activeSequenceBounds({ context: context2 }) : focusedBounds({ context: context2 }), { width, height, panZoom, transform } = nonNullable(context2.xystore).getState(), maxZoom = Math.max(1, transform[2]), viewport = getViewportForBounds(
      bounds,
      width,
      height,
      MinZoom,
    ...
    viewport.x = Math.round(viewport.x), viewport.y = Math.round(viewport.y), panZoom?.setViewport(viewport, duration > 0 ? { duration, interpolate: "smooth" } : void 0);
  }),
  alignNodeFromToAfterNavigate: (params) => machine.createAction(({ context: context2 }) => {
  ...
  setViewportCenter: (params) => machine.createAction(({ context: context2, event }) => {
    let center;
    params ? center = params : event.type === "update.view" ? center = BBox$1.center(event.view.bounds) : center = BBox$1.center(context2.view.bounds), invariant$1(context2.xyflow, "xyflow is not initialized");
    const zoom = context2.xyflow.getZoom();
    context2.xyflow.setCenter(Math.round(center.x), Math.round(center.y), { zoom });
  }),
  setViewport: (params) => machine.createAction(({ context: context2 }) => {
    const {
      viewport,
      duration = 350
    } = params;
    context2.xystore?.getState().panZoom?.setViewport(viewport, duration > 0 ? { duration, interpolate: "smooth" } : void 0);
  })
      ...
      if (e2.id === event.edge.id) {
        ...
        return {
          ...
          data: {
            ...
            labelXY: e2.data.labelXY ? pt : null
          }
        };
      }
      return e2;
...
}), emitOnChange = () => machine.enqueueActions(({ event, enqueue }) => {
  assertEvent(event, "emit.onChange"), enqueue.assign({
  ...
  if (context2.toggledFeatures.enableCompareWithLatest === !0) {
    if (currentLayoutType === "manual" && nextLayoutType === "auto") {
      const syncLayoutActor = typedSystem(system).syncLayoutActorRef, syncState = syncLayoutActor?.getSnapshot().value;
      syncLayoutActor && (syncState === "pending" || syncState === "paused") && (enqueue.sendTo(syncLayoutActor, { type: "cancel" }), enqueue.emit({
        type: "onChange",
        change: createViewChange(context2)
      }));
    }
...
})), updateInputs = () => machine.assign(({ event }) => (assertEvent(event, "update.inputs"), { ...event.inputs })), updateXYNodesEdges = () => machine.assign(({ context: context2, event }) => (assertEvent(event, "update.view"), {
  ...mergeXYNodesEdges({ context: context2, event }),
  lastClickedNode: null
})), focusOnNodesAndEdges = () => machine.assign(focusNodesEdges), undimEverything = () => machine.assign(({ context: context2 }) => ({
  xynodes: context2.xynodes.map(Base.setDimmed(!1)),
  xyedges: context2.xyedges.map(Base.setData({
    dimmed: !1,
    active: !1
  }))
})), updateActiveWalkthroughState = () => machine.assign(updateActiveWalkthrough), assignDynamicViewVariant = () => machine.assign(({ event }) => (assertEvent(event, "switch.dynamicViewVariant"), {
...
}), notationsHighlight = (params) => machine.assign(({ context: context2, event }) => {
  params || (assertEvent(event, "notations.highlight"), params = {
    ...event
  });
  const notation = params.notation, kinds = params.kind ? [params.kind] : notation.kinds;
  return {
    xynodes: context2.xynodes.map((n2) => {
      const node2 = findDiagramNode(context2, n2.id);
      return node2 && node2.notation === notation.title && node2.shape === notation.shape && node2.color === notation.color && kinds.includes(node2.kind) ? Base.setDimmed(n2, !1) : Base.setDimmed(n2, "immediate");
    }),
...
})), toggleFeature = () => machine.assign(({ context: context2, event }) => {
...
), isReadOnly = (context2) => context2.features.enableReadOnly || context2.toggledFeatures.enableReadOnly === !0, stopSyncLayout = () => machine.enqueueActions(({ enqueue, system }) => {
  const syncLayoutActor = typedSystem(system).syncLayoutActorRef;
  syncLayoutActor && enqueue.stopChild(syncLayoutActor);
}), ensureSyncLayout = () => machine.enqueueActions(({ context: context2, enqueue, system }) => {
  const syncLayoutActor = typedSystem(system).syncLayoutActorRef;
  if (isReadOnly(context2)) {
    syncLayoutActor && enqueue.stopChild(syncLayoutActor);
    return;
  }
  syncLayoutActor || enqueue.spawnChild("syncManualLayoutActorLogic", {
    id: "syncLayout",
    systemId: "syncLayout",
    input: {
...
), hasModelFqn = (node2) => "modelFqn" in node2.data && e$5(node2.data.modelFqn), openElementDetails = (params) => machine.enqueueActions(({ context: context2, event, enqueue, system }) => {
  ...
  if (fromNodeId && internalNode) {
    const nodeRect = nodeToRect(internalNode), zoom = context2.xyflow.getZoom(), clientRect = {
...
}), ensureOverlaysActorState = () => machine.enqueueActions(({ enqueue, context: { features }, system }) => {
...
}), ensureSearchActorState = () => machine.enqueueActions(({ enqueue, context: { features: { enableSearch } }, system }) => {
...
}), cancelFitDiagram = () => machine.cancel("fitDiagram"), raiseFitDiagram = (params) => machine.enqueueActions(({ enqueue }) => {
  enqueue.cancel("fitDiagram"), enqueue.raise(
    {
      type: "fitDiagram",
      ...e$1(params?.duration) ? { duration: params.duration } : {}
    },
    {
      id: "fitDiagram",
      ...e$1(params?.delay) ? { delay: params.delay } : {}
    }
  );
}), updateView = () => machine.enqueueActions(
  ({ enqueue, event, check, context: context2, system }) => {
    assertEvent(event, "update.view");
    const isAnotherView = check("is another view");
    if (enqueue(cancelFitDiagram()), isAnotherView) {
      enqueue(stopSyncLayout()), enqueue(closeAllOverlays()), enqueue(closeSearch()), enqueue.assign({
        focusedNode: null
      }), enqueue(disableCompareWithLatest());
      const { fromNode, toNode } = findCorrespondingNode(context2, event);
      fromNode && toNode ? (enqueue(xyflow.alignNodeFromToAfterNavigate({
        fromNode: fromNode.id,
        toPosition: {
          x: toNode.data.x,
          y: toNode.data.y
        }
      })), enqueue(raiseFitDiagram({ delay: 80 }))) : (enqueue(
        xyflow.setViewportCenter()
      ), enqueue(raiseFitDiagram({ duration: 200, delay: 25 }))), enqueue(updateXYNodesEdges()), enqueue(ensureSyncLayout());
      return;
    }
    enqueue(updateXYNodesEdges());
    const syncLayoutActor = typedSystem(system).syncLayoutActorRef;
    syncLayoutActor && enqueue.sendTo(syncLayoutActor, { type: "synced" });
    ...
    let recenter = !context2.viewportChangedManually;
    recenter = recenter || nextView._type === "dynamic" && context2.view._type === "dynamic" && nextView.variant !== context2.view.variant, recenter = recenter || context2.toggledFeatures.enableCompareWithLatest === !0 && !!nextView._layout && context2.view._layout !== nextView._layout, recenter && (enqueue(
      xyflow.setViewportCenter(BBox$1.center(nextView.bounds))
...
}), navigating$1 = machine.createStateConfig({
  id: "navigating",
  entry: [
    closeAllOverlays(),
    closeSearch(),
  ...
  on: {
    "update.view": {
      actions: enqueueActions(({ enqueue, context: context2, event }) => {
        enqueue(disableCompareWithLatest());
        const { fromNode, toNode } = findCorrespondingNode(context2, event);
        enqueue(
          fromNode && toNode ? xyflow.alignNodeFromToAfterNavigate({
            fromNode: fromNode.id,
            toPosition: {
              x: toNode.data.x,
              y: toNode.data.y
        ...
        ), enqueue.assign(updateNavigationHistory), enqueue(updateXYNodesEdges()), enqueue(ensureSyncLayout()), enqueue(raiseFitDiagram({ delay: 25 }));
      }),
      target: "#idle"
    }
  }
}), navigating = "#navigating", idle = machine.createStateConfig({
  id: "idle",
  on: {
    "xyflow.nodeClick": [
      {
    ...
    "xyflow.paneDblClick": {
      actions: [
        resetLastClickedNode(),
        xyflow.fitDiagram(),
        enqueueActions(({ context: context2, enqueue }) => {
          enqueue(
  ...
  exit: enqueueActions(({ enqueue, context: context2 }) => {
    enqueue.stopChild("hotkey"), context2.viewportBeforeFocus ? enqueue(xyflow.setViewport({ viewport: context2.viewportBeforeFocus })) : enqueue.raise({ type: "fitDiagram" }, { id: "fitDiagram", delay: 20 }), enqueue(undimEverything()), enqueue.assign({
  ...
  exit: enqueueActions(({ enqueue, context: context2 }) => {
    enqueue.stopChild("hotkey"), context2.viewportBeforeFocus ? enqueue(xyflow.setViewport({ viewport: context2.viewportBeforeFocus })) : enqueue(raiseFitDiagram({ delay: 10 })), context2.dynamicViewVariant === "sequence" && context2.activeWalkthrough?.parallelPrefix && enqueue.assign({
      xynodes: context2.xynodes.map((n2) => n2.type === "seq-parallel" ? Base.setData(n2, {
        color: SeqParallelAreaColor.default
      }) : n2)
    }), enqueue(undimEverything()), enqueue.assign({
  ...
  on: {
    ...
    "open.relationshipsBrowser": {
      actions: sendTo(({ system }) => typedSystem(system).overlaysActorRef, ({ context: context2, event, self }) => ({
        type: "open.relationshipsBrowser",
        subject: event.fqn,
        viewId: context2.view.id,
        scope: "view",
  ...
  write(toggledFeatures) {
    return sessionStorage.setItem(key, JSON.stringify(t$n(toggledFeatures, e$b))), toggledFeatures;
  }
...
function DiagramActorProvider({
  ...
  const xystore = useStoreApi(), actorRef = useActorRef(
    diagramMachine,
    {
      id: "diagram",
      systemId: "diagram",
  ...
  ), [api, setApi] = useState(() => makeDiagramApi(actorRef));
  useEffect(() => {
    setApi((api2) => api2.actor === actorRef ? api2 : makeDiagramApi(actorRef));
  }, [actorRef]), api.actor !== actorRef && console.warn("DiagramApi instance changed, this should not happen during the lifetime of the actor");
  ...
  return useEffect(
    ...
    _defaultVariant && actorRef.send({ type: "switch.dynamicViewVariant", variant: _defaultVariant });
  }, [_defaultVariant, actorRef]), console.debug("Render DiagramActorProvider for view", view.id), /* @__PURE__ */ jsxs(DiagramActorContextProvider, { value: api, children: [
    /* @__PURE__ */ jsxs(ErrorBoundary, { children: [
      ...
      /* @__PURE__ */ jsx(CurrentViewModelProvider, { actorRef, children })
    ] }),
...
const selectFromActor = ({ context: context2 }) => {
  ...
  const hasDrifts = context2.view.drifts != null, enableCompareWithLatest = context2.features.enableCompareWithLatest && (toggledFeatures.enableCompareWithLatest ?? !1) && e$8(context2.activeWalkthrough) && hasDrifts, enableReadOnly = context2.features.enableReadOnly || toggledFeatures.enableReadOnly || !!context2.activeWalkthrough || context2.dynamicViewVariant === "sequence" && context2.view._type === "dynamic" || enableCompareWithLatest && context2.view._layout === "auto";
...
const selectFromActor2 = (state) => state.context.dynamicViewVariant;
function DiagramXYFlowSyncProvider({ view, where, actorRef }) {
  ...
  }, [view, where, dynamicViewVariant, actorRef]), null;
}
const DiagramActorEventListener = memo$1(() => {
  ...
  useOnDiagramEvent("openSource", ({ params }) => onOpenSource?.(params)), useOnDiagramEvent("navigateTo", ({ viewId }) => onNavigateTo?.(viewId)), useOnDiagramEvent("onChange", ({ change }) => onChange?.({ change })), useOnDiagramEvent("onLayoutTypeChange", ({ layoutType }) => {
    onLayoutTypeChange?.(layoutType);
  });
  const wasEmitted = useRef(!1);
  return useEffect(() => {
    if (wasEmitted.current) return;
    let subscription = diagram.actor.on(
      "initialized",
      ({ instance: xyflow2 }) => {
        try {
          ...
          wasEmitted.current = !0, subscription?.unsubscribe(), subscription = null;
        }
      }
    );
    return () => {
...
}), scheme = (scheme2) => `[data-mantine-color-scheme="${scheme2}"]`, whenDark = scheme("dark"), whenLight = scheme("light"), MAX_DEPTH = 5, generateCompoundColors = (rootSelector, name, colors, depth) => {
...
function generateBuiltInColorStyles(rootSelector, theme) {
  return t$4(
    theme.colors,
    t$7(),
    t$b(([color, values]) => toStyle(rootSelector, color, values)),
    t$5(`
`)
  );
}
...
function LikeC4Diagram({
  ...
  const id = useId(), initialRef = useRef(null), bounds = pickViewBounds(view, dynamicViewVariant), fitViewPadding = useNormalizedViewPadding(_fitViewPadding);
...
function useNormalizedViewPadding(raw) {
  return useCustomCompareMemo(
    () => e$c(raw) ? t$p(raw, toLiteralPaddingWithUnit) : toLiteralPaddingWithUnit(raw),
    [raw],
    compareViewPaddingObject
  );
}
const compareViewPaddingObject = ([a], [b]) => a === b || e$c(a) && e$c(b) && a.bottom == b.bottom && a.left == b.left && a.right == b.right && a.top == b.top;
...
function LikeC4ProjectsProvider({
  ...
  const onProjectChange = useCallbackRef(_onProjectChange), value = useCustomCompareMemo(() => ({ projects, onProjectChange }), [projects, onProjectChange], shallowEqual);
  return /* @__PURE__ */ jsx(LikeC4ProjectsContext.Provider, { value, children });
}
